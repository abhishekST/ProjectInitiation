...
const BootstrapDialogTitle = (props: { [x: string]: any, children: any, onClose: any }): JSX.Element => {
...
const AddClientDialog = (props: { openDialog: any, handleClose: any }): JSX.Element => {
  ...
  const handleSubmit = (inputData: { firstName: string, middleName: string, lastName: string, designation: string, email: string }): void => {
    ...
    <>
      <Dialog open={openDialog} onClose={handleClose}>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={(e) => { handleSubmit(dialogData) }}>
            Submit
          </Button>
        </DialogActions>
      </Dialog>
